      ...
      <section className="mt-12 px-4 pb-16">
        <div className="max-w-[1800px] mx-auto flex flex-wrap justify-center items-start gap-6 mt-4 mb-4">
          {productVideos.map((video, index) => (
            <div
              key={index}
              className="rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-[#161b22]"
              style={{ width: "200px", height: "240px" }}
            >
              <video
                src={video}
        ...
        <div className="max-w-4xl mx-auto text-center mt-10 px-6">
          ...
          <p className="text-gray-800 dark:text-gray-200 text-sm md:text-base leading-relaxed italic" style={{color:"gray"}}>
            💎 <span className="font-medium">
              Please avoid exposing this jewellery to water or spraying perfume
              (or any chemicals) directly onto it.
            </span>{" "}
            Such exposure may damage the finish. If you refrain from both, the
            jewelry will remain in good&nbsp;condition.
          </p>
        </div>
      </section>
    </div>
