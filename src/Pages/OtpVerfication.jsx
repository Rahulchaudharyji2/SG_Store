    ...
    <div className="max-w-md mx-auto py-12 px-4">
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <input
          ...
          className="w-full border border-gray-200 rounded px-3 py-2 mb-3 mt-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        ...
        <button onClick={handleVerify} disabled={verifying} className="w-full bg-indigo-600 text-white py-2 rounded mb-2 hover:bg-indigo-700 disabled:opacity-60">
          {verifying ? "Verifying..." : "Verify OTP"}
        </button>

        <button onClick={handleSendOtp} disabled={sending || cooldown > 0} className="w-full border border-gray-200 py-2 rounded hover:bg-gray-50">
          {sending ? "Sending..." : cooldown > 0 ? `Resend OTP in ${cooldown}s` : "Resend OTP"}
        </button>
      </div>
    </div>
