...
function Earring() {
  // Match this exactly to your backend category name if different (e.g., "Earrings")
  ...
  return (
    <>
      {/* Hero carousel */}
      <ProdoctCarousel
        img2="https://res.cloudinary.com/dgooittzu/image/upload/v1758304021/7_hkczkr.png"
        img1="https://res.cloudinary.com/dgooittzu/image/upload/v1758348071/4_b6ojoj.png"
      />
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            <Stack spacing={0.5}>
              ...
              <Typography variant="body2" color="text.secondary">
                Explore our earring collection. Use search to quickly find items.
              </Typography>
            </Stack>
            ...
            >
              <TextField
                ...
                placeholder="Search earrings by title..."
                size="small"
          ...
          {error && (
            ...
            >
              {error?.data?.message || 'Failed to load earrings'}
            </Alert>
          )}
              ...
              <Grid item xs={12}>
                <Box sx={{ textAlign: 'center', py: 6 }}>
                  <Typography variant="body1" color="text.secondary">
                    No earrings found{debouncedQ ? ` for “${debouncedQ}”` : ''}.
                  </Typography>
                </Box>
              </Grid>
            )}
